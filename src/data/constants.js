...
export const AREAS = ['hall', 'shelf', 'window'];

export const AREA_NAMES = { hall: '大厅', shelf: '猫爬架', window: '窗边' };
...
export const EVENTS = {
    ...
    REPUTATION_CHANGED: 'state:reputation',
    CATS_CHANGED: 'state:cats',
    CUSTOMERS_CHANGED: 'state:customers',
    AREAS_CHANGED: 'state:areas',
    MENU_CHANGED: 'state:menu',
    STORIES_CHANGED: 'state:stories',
    SHOP_CHANGED: 'state:shop',
    LOG_ADDED: 'state:log',
    STATS_CHANGED: 'state:stats',
    CAT_ADOPTED: 'cat:adopted',
    CAT_ASSIGNED: 'cat:assigned',
    CAT_BOND_CHANGED: 'cat:bond',
    CUSTOMER_SPAWNED: 'customer:spawned',
