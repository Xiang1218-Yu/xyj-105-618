...
export const CAT_STORIES = {
    1: { title: '小巷里的等待', content: '小橘曾经是一只在菜市场附近流浪的猫咪。每天它都守在同一个巷口，等待着那个曾经喂过它一次的小女孩。下雨天它会躲在纸箱里，饿了就翻找垃圾桶，但它从未离开那个巷口。直到有一天，你的出现，让它重新感受到了家的温暖。' },
    2: { title: '屋顶上的冒险家', content: '花花是这片街区最勇敢的猫咪。它曾经爬上最高的屋顶，只为追逐一只蝴蝶。从那以后，它爱上了在屋顶漫步的感觉。然而有一次，它从屋顶摔下来，腿受伤了，只能在角落里独自舔舐伤口。幸运的是，你发现了它，给了它一个安全的家。' },
    3: { title: '纸箱里的三朵花', content: '年糕和它的两个兄弟姐妹一起被遗弃在公园的纸箱里。那是一个寒冷的冬天，三只小猫蜷缩在一起取暖。另外两只小猫被好心人领养了，只剩下年糕，因为它的一只眼睛有轻微的残疾。但在你眼里，它是最特别的那一个。' },
    4: { title: '黑白配的小调皮', content: '麻薯因为太调皮被前主人送走了。它喜欢打翻水杯，喜欢在凌晨三点跑酷，喜欢把纸巾撕得满天飞。前主人觉得它太闹腾了，于是把它丢在了路边。但你知道，这些看似调皮的行为，只是它想要被关注的方式。' },
    5: { title: '黑夜中的精灵', content: '玄猫常常被人们误解为带来厄运的象征。因为这个原因，它一次次被领养，又一次次被送回。它开始变得不信任人类，总是躲在角落里观察。直到你出现，你不在乎那些迷信的说法，你只知道它是一只需要被爱的猫咪。' },
    6: { title: '白雪公主的眼泪', content: '雪球曾经是一只被宠爱的家养猫。它的主人是一位老奶奶，每天都抱着它晒太阳。后来老奶奶去世了，家人把雪球丢在了外面。雪白的毛发变得脏乱，但它依然每天坐在老房子门口等待。你经过时，它轻轻地蹭了蹭你的腿，像是在寻求一个新的开始。' },
    7: { title: '蓝胖子的忧伤', content: '这只英短蓝猫被主人买来作为送给女朋友的礼物。然而两人分手后，谁也不愿意继续养它。它被辗转送给了好几户人家，每一次都以为自己找到了家，每一次都失望。它变得越来越沉默，越来越不爱动。直到遇见你，它才重新开始信任人类。' },
    8: { title: '银色的月光', content: '银渐层是从繁殖场救出来的。它的一生都被关在狭小的笼子里，不断地生育。当它再也无法生育时，繁殖场准备把它处理掉。幸运的是，志愿者救下了它。刚到你家时，它甚至不会走路，因为它从来没有在地面上自由行走过。' },
    12: { title: '布偶的秘密', content: '这只布偶猫有着完美的外貌，却被主人丢弃在宠物医院门口。原来它患有先天性的心脏病，需要长期服药。主人不愿意承担治疗费用，选择了放弃。你把它带回了家，虽然医药费很贵，但每天看到它温柔的眼神，你知道一切都是值得的。' },
    17: { title: '无毛的温暖', content: '斯芬克斯猫因为独特的外表，经常被人用异样的眼光看待。它的前主人买它只是为了炫耀，后来新鲜感过了就不再管它。没有毛发的它在冬天特别怕冷，只能蜷缩在暖气旁边。你给它穿上了小衣服，给了它满满的爱。它虽然没有毛，但它的心是温暖的。' },
    20: { title: '小豹子的归处', content: '这只孟加拉豹猫被非法走私贩卖，在运输途中受尽了折磨。被警方解救后，它对人类充满了恐惧。你花了整整三个月的时间，每天静静地坐在它旁边，给它喂食，跟它说话。终于有一天，它主动走到了你身边，把头靠在了你的腿上。' },
    33: { title: '矮脚猫的大梦想', content: '曼基康因为天生的短腿，常常被其他猫咪欺负。它跑不快，跳不高，只能看着其他猫咪在高处玩耍。但它从来没有放弃过，它会用自己的方式探索这个世界。你给了它一个充满爱的家，在这里，它不需要跑得快，不需要跳得高，只需要做一只快乐的小猫咪。' }
};
